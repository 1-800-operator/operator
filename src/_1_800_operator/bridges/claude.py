...
# dial-mode reply attribution. Locked S193 (Phase 14.19.6) after side-by-side
...
REPLY_PREFIX_DIAL = "[🤖 Claude] "

# There is no separate operator voice. Everything the bot says in a
# meeting goes out under REPLY_PREFIX_DIAL — operator is invisible
