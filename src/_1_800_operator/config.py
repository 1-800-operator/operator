...
if not BOT_NAME:
    sys.stderr.write(
        ...
        "Run via the CLI: `operator dial <name> [url]`.\n"
    )
    raise SystemExit(2)
...
MAX_TOKENS                 = 2000  # runaway guard on LLM output; "be brief" system-prompt does the real shaping. Bumped from 1000 in session 159 — multi-paragraph skill outputs (pr-review, release-notes) need ~1200–1800 tokens to deliver entry-point through closing-question without truncation.
